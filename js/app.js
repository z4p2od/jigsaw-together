...
function handleFile(file) {
  ...
  reader.onload = (e) => {
    ...
    // Compress to JPEG 0.92 via canvas and strip prefix
    const img = new Image();
    img.onload = () => {
...
/**
 * Returns { cols, rows } whose product is closest to pieceCount
 * and whose ratio is closest to the image's aspect ratio.
 */
...
/**
 * Returns array of { x, y } random positions spread across the board area.
 * Board is sized to 900x650 for a comfortable desktop default.
 */
